# AUTOGENERATED! DO NOT EDIT! File to edit: 01_opusapi.ipynb (unless otherwise specified).

__all__ = ['base_url', 'metadata_url', 'image_url', 'dic', 'MetaData', 'OPUSImageURL', 'OPUSObsID', 'OPUS']
